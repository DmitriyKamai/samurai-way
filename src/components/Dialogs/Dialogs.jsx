    ...
    <main className={s.dialogs}>
      ...
      <div className={s.messages}>
        ...
        <div className={s.messagesArea}>
          <MessageItem message="Поехали на дачу охотиться за мышами, пить молоко, сосать сиску у коровок, гонять собак, лизать свою шерсть и делать котят" imgSrc="https://i.pinimg.com/236x/c8/cc/24/c8cc24bba37a25c009647b8875aae0e3.jpg" />
        </div>
