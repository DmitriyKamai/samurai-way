...
const UserItem = (props) => {
  ...
  const addFriend = () => {
    axios.post(`https://social-network.samuraijs.com/api/1.0/follow/${userItem.current.dataset.id}`, {},
  ...
  const deleteFriend = () => {
    axios.delete(`https://social-network.samuraijs.com/api/1.0/follow/${userItem.current.dataset.id}`,
      { withCredentials: true, headers: { 'API-KEY': '49ea7a73-ff67-49c4-b332-1f9bef8e582a' } },
    )
      .then(response => {
        console.log(response)
